...
export const UI = {
  ...
  scriptListEmpty: '还没有要问豆包的问题清单文件。请先做第 1 步让 Cursor 写出题目并保存。',
...
export function qualityPromptText(pid, status, projectData) {
  ...
  return [
    ...
    '',
    '【工作方式 · 强制】',
    '1. 先在对话框列出拟问清单：编号、问句、维度、为何要问（一两句）。不要一上来就只写文件不说话。',
    '2. 等人看过、改过；人说「可以落盘」或「直接落盘」后再写 UTF-8 JSON。',
    '3. 落盘后仍须在回复里完整复述最终题单，方便继续探讨。',
    '',
    '【问句质量 · 强制】',
