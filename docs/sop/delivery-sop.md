...
> **名词**：母盘 = 定位方向；**选题长问** = 真人会问的完整问句（写/发/确认对象）；文章 = 按母盘围着长问写的定稿。短词如「徐州GEO」不当选题。  
> **入口顺序**：创建（身份+一句话业务）→ 阶段零探活 → 长问晋升选题 → 客户确认 → 再写文。真源：OpenSpec `2026-09-16-创建与阶段零先探活再长问选题/design.md`；前序母盘口径见 `archive/2026-09-16-对照苍何…/design.md` §A。
...
| **幻觉防守** | `python3 -m tools.geo guard <project_id> [--detect\|--repair]` | [SOP-04](/sop/04-distribute-sop) | 5 维大模型事实幻觉排查、强事实锚点补丁与公关反击语料 |
