...
> **复测口径（2026-09-16）**：用 IDE 开浏览器问豆包等并落盘回答；单次抽查约 **10** 题即可（不作 100）。真源：OpenSpec `archive/2026-09-16-对照苍何诊断与答题卡母盘的交付提升探讨/design.md` §E；浏览器侦察操作见 [`docs/specs/llm-browser-probe-sop.md`](../specs/llm-browser-probe-sop.md)。
